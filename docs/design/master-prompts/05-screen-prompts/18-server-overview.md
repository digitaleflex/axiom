...
Create the infrastructure server overview. Show server inventory with readiness, liveness, CPU, RAM, disk, agent version, capabilities, active applications and last-seen information. Provide clear actions to inspect a server and identify degraded/offline infrastructure.
