...
### Server Overview
Infrastructure server inventory: readiness, liveness, CPU, RAM, disk, agent version, capabilities, active applications and last-seen information. Identify degraded/offline infrastructure.
