...
### Server Selection
Eligible infrastructure servers with readiness, CPU, RAM, disk, agent version, Docker/Traefik/TLS capabilities and last-seen status. Clearly show READY, DEGRADED and OFFLINE.
