...
Operational home for one application: identity, environment selector, LIVE/FAILED state, domain, current deployment, runtime, server, health, resource signals and recent activity.
