...
Create the production application overview. Show application identity, environment selector, current LIVE/FAILED state, domain, current deployment, runtime, server, health summary, resource signal, recent activity and primary deployment actions. This is the operational home for one application.
