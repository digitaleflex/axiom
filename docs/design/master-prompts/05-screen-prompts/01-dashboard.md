...
### Dashboard
Main operational dashboard after sign-in: applications, active deployments, server health, recent deployment activity, GitHub repositories, environment context, and primary Deploy action.
