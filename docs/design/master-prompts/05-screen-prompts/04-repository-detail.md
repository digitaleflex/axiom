...
Create the repository detail screen before deployment. Show repository identity, branch/ref selector, recent commits, detected files/configuration signals, existing Axiom deployments, and the primary Analyze Repository action.
