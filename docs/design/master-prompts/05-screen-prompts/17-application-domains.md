...
Create the domains and TLS management screen. Show primary domain, aliases, DNS/TLS status, certificate state, routing target, environment association and safe actions to add/edit/remove domains. Make certificate and routing problems immediately visible.
