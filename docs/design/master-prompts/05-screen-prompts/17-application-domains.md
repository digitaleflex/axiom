...
### Application Domains
Domains/TLS management: primary domain, aliases, DNS/TLS status, certificate state, routing target, environment and safe add/edit/remove actions. Make routing/certificate problems obvious.
