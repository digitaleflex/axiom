...
Create the application profile review screen after analysis. Show the canonical detected profile: language, framework, package manager, build command, start command, port, container strategy, services, configuration and confidence/evidence. Clearly distinguish detected values from user overrides. Provide Continue to Server Selection.
