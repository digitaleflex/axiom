...
Selected repository/ref, application profile, server, environment, domain, port, health check and runtime/build settings. Make safe defaults visible. Primary Review Deployment Plan action.
