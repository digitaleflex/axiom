...
Create the GitHub connection screen. Show connection status, GitHub account identity, permissions/scopes in a concise technical way, accessible repositories, connection/reconnection actions, and a secure success state. Make the trust boundary and account context obvious without exposing secrets.
