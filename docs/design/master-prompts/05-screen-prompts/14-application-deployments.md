...
Create the deployment history screen for one application. Show a dense but readable chronological table/timeline of deployments with status, commit/ref, environment, server, duration, timestamp and initiator. Include filtering and a clear path into a deployment detail.
