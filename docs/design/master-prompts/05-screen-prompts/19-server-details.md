...
Create the detailed server operations screen. Show server identity, connection/agent status, capabilities, resource telemetry, managed Axiom runtimes, active deployments, Traefik/networking state, recent agent events and safe operational actions. Clearly separate Axiom-managed resources from unknown host resources.
