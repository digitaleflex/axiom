...
### Application Metrics
Operational metrics: CPU, memory, runtime health, supported request/application telemetry, deployment correlation and time ranges. Avoid decorative charts; each visualization must communicate an operational signal.
