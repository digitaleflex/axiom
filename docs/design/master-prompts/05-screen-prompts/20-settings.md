...
### Settings
Axiom settings: account/profile, GitHub connection, organizations/workspaces, security, API/access, notifications, environments and platform preferences. Isolate destructive actions with strong safeguards.
