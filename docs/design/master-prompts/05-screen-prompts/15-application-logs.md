...
Create the operational logs screen. Show a real-time terminal-style log viewer for an Axiom-managed application, with timestamps, severity, deployment correlation, search/regex filtering, pause/resume streaming, copy controls, line wrapping/folding and bounded history controls. Never imply host-wide unrestricted logs.
